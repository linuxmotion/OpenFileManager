 ...
 */
public class ExtendedMimeTypeMap {

    /**
     * Singleton MIME-type map instance:
     */
    private static ExtendedMimeTypeMap sMimeTypeMap;
     ...
     */
    public static ExtendedMimeTypeMap getSingleton() {
        if (sMimeTypeMap == null) {
            sMimeTypeMap = new ExtendedMimeTypeMap();
            ...
            sMimeTypeMap.loadEntry("application/x-javascript", "js");
            ...
            sMimeTypeMap.loadEntry("text/plain", "log");
